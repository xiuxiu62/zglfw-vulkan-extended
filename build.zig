...
pub fn build(b: *std.Build) void {
    ...
    const options = .{
        ...
        // .enable_vulkan = b.option(
        //     bool,
        //     "vulkan",
        //     "Whether to build with Vulkan support (default: true)",
        // ) orelse true,
    };
    ...
    // const vulkan_module = b.option(
    //     *std.Build.Module,
    //     "vulkan_module",
    //     "Shared Vulkan module passed from parent",
    // );
    ...
    // if (vulkan_module) |vk| module.addImport("vulkan", vk);
...
// fn generate_vulkan_headers(options) void {
...
//         glfw.root_module.addAnonymousImport("vulkan", .{
