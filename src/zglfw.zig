...
pub fn getInstanceProcAddress(instance: vk.Instance, procname: [*:0]const u8) ?GlProc {
    return glfwGetInstanceProcAddress(instance, procname);
}
extern fn glfwGetInstanceProcAddress(instance: vk.Instance, procname: [*:0]const u8) ?GlProc;
...
pub fn createWindowSurface(
    ...
    const result = glfwCreateWindowSurface(instance, window, allocator, &surface);
